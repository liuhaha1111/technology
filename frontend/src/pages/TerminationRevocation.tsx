...
export default function TerminationRevocation() {
  const tableData = [
    { id: 1, year: '2015', name: '具有长服务周期的工业复杂系统可适化方法研究', leader: '张昕', unit: '长春理工大学', department: '国际合作处', time: '2015-2017', amount: '10.0', status: '暂未申请', action: '项目验收已完成!' },
    { id: 2, year: '2019', name: '面向城市精细化治理的智能路径规划服务', leader: '张昕', unit: '长春理工大学', department: '社发处', time: '2019-2021', amount: '20.0', status: '暂未申请', action: '项目验收已完成!' },
    { id: 3, year: '2020', name: '基于位置服务发现的新能源交通设施规划方法研究', leader: '张昕', unit: '长春理工大学', department: '基础研究处', time: '2020-2022', amount: '8.0', status: '暂未申请', action: '项目验收已完成!' },
    { id: 4, year: '2026', name: '激光共聚焦显微镜设备功能提升改造', leader: '张昕', unit: '长春理工大学', department: '科技资源统筹处', time: '2026-2028', amount: '45.0', status: '暂未申请', action: '申请填写' },
  ];
  ...
  return (
    <div className="p-4">
      <div className="bg-gradient-to-b from-blue-400 to-blue-600 dark:from-blue-600 dark:to-blue-800 p-2 mb-4 flex items-center text-sm shadow-sm rounded">
        ...
        <span className="text-white">终止撤销</span>
      </div>
        ...
        <table className="w-full text-sm text-center border-collapse">
          <thead className="bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-medium">
            <tr>
              ...
              <th className="py-3 px-4 border border-slate-200 dark:border-slate-700 w-24">合同金额</th>
          ...
          <tbody className="divide-y divide-slate-200 dark:divide-slate-700 text-slate-600 dark:text-slate-400">
            {tableData.map((row) => (
              <tr key={row.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition">
                ...
                <td className="py-3 px-4 border border-slate-200 dark:border-slate-700">{row.amount}</td>
